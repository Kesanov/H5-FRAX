...
SKILLS = {
    ...
    RUSH: ( 'POWER_OF_HASTE', 'TELEPORT_ASSAULT', 'SNATCH', 'DEATH_TREAD', 'RUNIC_MACHINES' , 'WILDFIRE'),
    ...
    NECROMANCY: ( 'DEATH_SCREAM', 'SHRUG_DARKNESS', 'CHILLING_BONES', 'HERALD_OF_DEATH', 'NO_REST_FOR_THE_WICKED', 'LORD_OF_UNDEAD' ), # 'HAUNT_MINE'
...
HEROES = {
    ...
    'BEASTMASTER':  ('D', 1, (40,30,15), CHAOS      , BASIC({})                + MIGHT + [CHAOS]), # OVERLORD
    ...
    'RANGERA':      ('S', 1, (45,30,10), AVENGER    , BASIC({STAMINA: LIGHT})  + MIGHT + [AVENGER]), # RANGER
    'WARDEN':       ('S', 2, (35,25,15), AVENGER    , BASIC({RUSH: DARK})      + MIGHT + [AVENGER, CHAOS]), # AVENGER
    'ENCHANTER':    ('S', 3, (10,20,40), DEFENCE    , BASIC({})                + MAGE2 + [LIGHT, SUMMON]), # DRUID
    'GUILDMASTER':  ('A', 1, (35,25,10), LEADERSHIP , BASIC({LUCK: LIGHT})     + [DARK, LEADERSHIP, MACHINES, ARTIFICIER]), # ENCHANTER
